...
// Filter options
const PLATFORMS = ['Web', 'SaaS', 'Mobile App'] as const
const FOCUSES = ['Systems', 'Data', 'AI', 'Social Media', 'Conversion', 'Architecture'] as const
const CONTEXTS = ['Enterprise', 'Startup', 'B2B', '0 → 1', 'D2C'] as const
